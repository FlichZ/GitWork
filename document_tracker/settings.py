"""
Django settings for DocFlow Guardian project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'docflow_guardian'),
...
# For local development, use SQLite if the DJANGO_USE_SQLITE env var is set
if os.environ.get('DJANGO_USE_SQLITE', False):
    DATABASES = {
    'default': {
